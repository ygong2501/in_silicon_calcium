...
try:
    ...
    try:
        ...
        print(f"WARNING: CuPy issue: {e}")
        print("Attempting to install CuPy for CUDA 12...")
        try:
            ...
            HAS_GPU = True
            print("Successfully installed and enabled GPU acceleration with CuPy for CUDA 12")
...
class CalciumSignalingGUI:
    def __init__(self, root):
        ...
        if not HAS_GPU:
            messagebox.showwarning(
                ...
                "3. Install cupy with: pip install cupy-cuda12x\n"
    ...
    def run_simulation(self):
        ...
        if HAS_GPU:
            ...
            self.log_output("1. Download and install CUDA Toolkit 12.x from NVIDIA website\n")
            self.log_output("2. Install CuPy with: pip install cupy-cuda12x\n")
